...
namespace KlayGE
{
		...
		std::shared_ptr<KeyFramesType> const & kfs, uint32_t num_frames, uint32_t frame_rate)
	{
		...
		for (size_t i = 0; i < mtls.size(); ++ i)
		{
			...
			static_assert(static_cast<int>(MeshMLObj::Material::TS_Albedo) == static_cast<int>(RenderMaterial::TS_Albedo),
				"Albedo texture slot doesn't consistent");
			static_assert(static_cast<int>(MeshMLObj::Material::TS_Metalness) == static_cast<int>(RenderMaterial::TS_Metalness),
				"Metalness texture slot doesn't consistent");
			static_assert(static_cast<int>(MeshMLObj::Material::TS_Glossiness) == static_cast<int>(RenderMaterial::TS_Glossiness),
				"Glossiness texture slot doesn't consistent");
			static_assert(static_cast<int>(MeshMLObj::Material::TS_Emissive) == static_cast<int>(RenderMaterial::TS_Emissive),
				"Emissive texture slot doesn't consistent");
			static_assert(static_cast<int>(MeshMLObj::Material::TS_Normal) == static_cast<int>(RenderMaterial::TS_Normal),
				"Normal texture slot doesn't consistent");
			static_assert(static_cast<int>(MeshMLObj::Material::TS_Height) == static_cast<int>(RenderMaterial::TS_Height),
